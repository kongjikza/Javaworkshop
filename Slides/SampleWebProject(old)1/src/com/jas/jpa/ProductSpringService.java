...
public class ProductSpringService {
	...
	@ResponseBody // ถ้าจะ  Return กลับ ต้องกำหนดด้วย
	public Product getProduct(@PathVariable("productId") int productId) {
		...
		try {
			TypedQuery<Product> query = em.createQuery(
					"SELECT e FROM Product e WHERE e.productid = :productId", Product.class); // Table ต้องระบุชื่อ Class ไม่ใช้ขื่อ Table
